          ...
          <StyledDiv onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
            ...
            <TitleHeaderDiv>
              <FlexWrapper className="header-title">
                <Text color={isDark ? "#FFFFFF" : "#000000"} fontFamily="'DM Sans', sans-serif" className="deposit-title">{pool?.stakingToken?.symbol || ''} - {pool?.earningToken?.symbol || ''} Stablecoin Pool</Text>
