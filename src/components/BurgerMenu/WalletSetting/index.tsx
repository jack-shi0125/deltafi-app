      ...
      <StyledMenu open={open} full={isFullNavigation} aria-hidden={!isHidden} {...props}>
        <Container onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
          ...
          <Wrapper>
            <ConnectList>
              <ConnectItem>
                <ChangeNetworkIcon isDark={isDark} className="icon" />
                <Text color={isDark ? "#FFF" : "#23242F"} fontFamily="'DM Sans', sans-serif" className="connect-type">Change Network</Text>
              </ConnectItem>
              <ConnectItem>
                <MigrateTokensIcon isDark={isDark} className="icon" />
                <Text color={isDark ? "#FFF" : "#23242F"} fontFamily="'DM Sans', sans-serif" className="connect-type">Migrate Tokens</Text>
              </ConnectItem>
              <ConnectItem onClick={onCopyAddress}>
              ...
              <ConnectItem onClick={onDisconnectWallet}>
