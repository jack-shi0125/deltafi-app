      ...
      <Container onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
        ...
        <StyledDiv>
          {isConnectedWallet ? <ConnectedWallet />
            :
            <Button variant='secondary' className="connect-btn" borderRadius="5px" onClick={() => setHeaderOpen(!headerOpen)}>
        ...
        <Wrapper>
          <ConnectList>
            ...
            <ConnectItem onClick={() => window.open(`${GITHUB_LINK}/deltafi-app/blob/main/README.md`, "_blank")}>
            ...
            <ConnectItem onClick={() => window.open(GITHUB_LINK, "_blank")}>
            ...
            <ConnectItem onClick={() => window.open(DISCORD_LINK, "_blank")}>
