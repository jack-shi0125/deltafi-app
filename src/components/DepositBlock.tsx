    ...
    <>
      ...
      <ShareDiv>
        <FlexWrapper className="deposit">
          <FlexWrapper>
            <DepositButton name="depositButton" onClick={buttonClciked} >
            ...
            <DepositButton name="withdrawButton" onClick={buttonClciked}>
          ...
          <DepositDetailImg src={isDark ? '/images/deposit-detail-dark.png' : '/images/deposit-detail-light.png'} alt="Deposit Detail" onClick={handleOpenSettings} />
        </FlexWrapper>
