      ...
      <Container open={headerOpen || depositOpen || stakeOpen || menuOpen || settingOpen}>
        ...
        <Section>
          <FlexWrapper>
            ...
            <DepositDetailImg src={`/images/deposit-detail-${isDark ? 'dark' : 'light'}.png`} alt="Deposit Detail" onClick={handleOpenSettings} />
          </FlexWrapper>
          <ReactCardFlip isFlipped={openSettings}>
            <>
              ...
              {isConnectedWallet ?
                <Button name="amount" className="connect-wallet" borderRadius="5px" onClick={() => {}}>
                  ENTER AMOUNT
                </Button>
              :
